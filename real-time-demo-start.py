...
data_folder = os.path.join(cwd, '..', 'rtfin-data')
try:
    os.makedirs(data_folder)
except OSError as error:
    print(error)
data_path_relative = os.path.join('..', 'rtfin-data','sub-' + participant, 'Muse_data')
...
command = ''.join(['start ', venv_path, ' ; .\\venv\\Scripts\\python.exe rtfin_demo.py -p ', participant, ' -s ', str(t_init)])
