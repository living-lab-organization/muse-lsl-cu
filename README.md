...
Edited by John Thorp @jnthorp for Windows to automatically open multiple terminal windows, monitor whether the muse is delivering EEG signal, and, if not, disconnect and reconnect.
